    ...
    >
      ...
      <section className=" text-white py-10 flex flex-col justify-center items-center mx-10 lg:mx-5">
        ...
        <div className="w-full mt-10">
          ...
          <p className="text-xl md:text-2xl mb-8 text-center my-10 text-slate-400">
        ...
        <div className="w-full absolute bottom-[100px] gap-y-2 justify-center items-center">
          ...
          >
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-blue-500/20 rounded-full py-1 cursor-pointer hover:bg-blue-500/25 transition-all px-4 border border-blue-500 text-blue-400'>
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-emerald-500/20 rounded-full py-1 cursor-pointer hover:bg-emerald-500/25 transition-all px-4 border border-emerald-500 text-emerald-400'>
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-rose-500/20 rounded-full py-1 cursor-pointer hover:bg-rose-500/25 transition-all px-4 border border-rose-500 text-rose-400'>
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-teal-500/20 rounded-full py-1 cursor-pointer hover:bg-teal-500/25 transition-all px-4 border border-teal-500 text-teal-400'>
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-amber-500/20 rounded-full py-1 cursor-pointer hover:bg-amber-500/25 transition-all px-4 border border-amber-500 text-amber-400'>
            ...
            <SwiperSlide>
              ...
              <div className='w-full flex justify-center text-center items-center h-[20vh]'>
                <button className='text-sm font-semibold md:text-base outline-none flex gap-x-2 items-center  bg-pink-500/20 rounded-full py-1 cursor-pointer hover:bg-pink-500/25 transition-all px-4 border border-pink-500 text-pink-400'>
